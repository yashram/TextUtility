          ...
          <nav className="navbar navbar-expand-lg bg-body-tertiary">
            <div className="container-fluid">
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li className="nav-item"><a className="nav-link" href="/businesst">Business</a></li>
                    <li className="nav-item"><a className="nav-link" href="/entertainmentt">Entertainment</a></li>
                ...
                <form className="d-flex" id ="serchForm" role="search">
                    <input className="form-control me-2" id ="serchForm" type="search" placeholder="Search" aria-label="Search"/>
